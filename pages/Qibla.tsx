  ...
  return (
    <div className="flex flex-col items-center justify-center h-[80vh] text-center p-4">
      <div className="relative w-48 h-48 mb-8">
        ...
        <div className="absolute inset-2 border-2 border-gray-400 dark:border-gray-500 rounded-full"></div>
        ...
        <div className="absolute top-1/2 left-1/2 w-4 h-4 -translate-x-1/2 -translate-y-1/2 bg-gray-600 dark:bg-gray-300 rounded-full"></div>
