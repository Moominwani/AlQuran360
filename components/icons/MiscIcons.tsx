...
export const PaletteIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 6.087c0-.66.537-1.197 1.197-1.197h.001a1.197 1.197 0 011.196 1.197v.001c0 .66-.537 1.197-1.197 1.197h-.001a1.197 1.197 0 01-1.196-1.197v-.001z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.975 11.25c0-.66.537-1.197 1.197-1.197h.001a1.197 1.197 0 011.196 1.197v.001c0 .66-.537 1.197-1.197 1.197h-.001a1.197 1.197 0 01-1.196-1.197v-.001z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 11.25c0-.66.537-1.197 1.197-1.197h.001a1.197 1.197 0 011.196 1.197v.001c0 .66-.537 1.197-1.197 1.197h-.001A1.197 1.197 0 019 11.25v-.001z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 6.087c0-.66.537-1.197 1.197-1.197h.001a1.197 1.197 0 011.196 1.197v.001c0 .66-.537 1.197-1.197 1.197h-.001A1.197 1.197 0 017.5 6.087v-.001z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a8.25 8.25 0 005.54-2.313a8.25 8.25 0 000-11.374A8.25 8.25 0 0012 3a8.25 8.25 0 00-5.54 2.313 8.25 8.25 0 000 11.374A8.25 8.25 0 0012 21zM12 3v.001" />
    </svg>
);
...
export const VibrationOnIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 6.878V17.12a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 17.12V6.878M2.25 12h1.5m16.5 0h1.5M12 2.25v1.5m0 16.5v1.5" />
    </svg>
);

export const VibrationOffIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 6.878V17.12a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 17.12V6.878" />
...
export const CrownIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 018.638 5.214l2.11-2.11a.5.5 0 01.708 0l2.11 2.11zm-2.11 0a4.5 4.5 0 00-4.242 0" />
    </svg>
);
...
export const AzkarIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" {...props}>
        <path d="M13.91 18.42a5.5 5.5 0 1 0-7.82-7.82" />
        <circle cx="18.5" cy="5.5" r="2.5" />
        <circle cx="5.5" cy="18.5" r="2.5" />
        <path d="M12 12a2.5 2.5 0 1 0-5 0 2.5 2.5 0 0 0 5 0Z" />
        <path d="M15.5 8.5a2.5 2.5 0 1 0-5 0 2.5 2.5 0 0 0 5 0Z" />
    </svg>
);
...
export const NearbyMosqueIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M4 22h16" />
      <path d="M12 9a4 4 0 0 0-4 4v0a4 4 0 0 0 4 4v0a4 4 0 0 0 4-4v0a4 4 0 0 0-4-4Z" />
      <path d="M12 2v2" />
      <path d="M4 13h2" />
      <path d="M18 13h2" />
      <path d="M12 22V17" />
...
export const QiblaCompassIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="10"></circle><path d="m12 18 4-12-8 4 4 4Z"></path></svg>
);
...
export const PrayerManIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M18.75 7.5a.75.75 0 0 0-1.5 0v1.944a4.5 4.5 0 0 0-8.502 0V7.5a.75.75 0 0 0-1.5 0v1.944a6 6 0 0 0 11.502 0V7.5z" />
      <path fillRule="evenodd" d="M8.625 15a.75.75 0 0 1 .75.75v3.193l.354.353a.75.75 0 0 1-1.06 1.06l-1.5-1.5A.75.75 0 0 1 7 18.25v-2.5a.75.75 0 0 1 .75-.75h.875zM15.375 15a.75.75 0 0 1 .75.75v2.5c0 .414-.336.75-.75.75l-1.5 1.5a.75.75 0 0 1-1.06-1.06l.353-.353V15.75a.75.75 0 0 1 .75-.75h.875z" clipRule="evenodd" />
    </svg>
);
...
export const FilledBookmarkIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
